...
uses
  ...
  zexmlss, zexmlssutils, zexlsx, zeodfs, TypInfo, StrUtils, zeformula;
...
begin
  ...
  sd.Filter := 'Excel XML 2002 (*.xml)|*.xml|OpenDocument|*.ods|Office OpenXML|*.xlsx';
  sd.DefaultExt := 'xml';
  ...
  begin
    ...
    try
     ...
     begin
      ...
      case _ftype of
        0: SaveXmlssToEXML(tz, sd.FileName, [0, 1], [], @my_local_to_some_encoding, 'UTF-8');
        1: SaveXmlssToODFS(tz, sd.FileName, [0, 1], [], @my_local_to_some_encoding, 'UTF-8');
        2: SaveXmlssToXLSX(tz, sd.FileName, [0, 1], [], @my_local_to_some_encoding, 'UTF-8');
      end;
