...
private:
	...
	void __fastcall SetAttr(int num, AnsiString * Value);
...
public:
	...
	void __fastcall Add(AnsiString * Attr, bool TestMatch = true)/* overload */;
	...
	void __fastcall Insert(int Index, AnsiString * Attr, bool TestMatch = true)/* overload */;
...
public:
	...
	void __fastcall WriteEmptyTag(AnsiString TagName, AnsiString * AttrArray, const int AttrArray_Size, bool StartNewLine, bool CheckEntity = true)/* overload */;
	...
	void __fastcall WriteEmptyTag(AnsiString TagName, AnsiString * AttrArray, const int AttrArray_Size)/* overload */;
	...
	void __fastcall WriteInstruction(AnsiString InstructionName, AnsiString * AttrArray, const int AttrArray_Size, bool StartNewLine, bool CheckEntity = true)/* overload */;
	...
	void __fastcall WriteInstruction(AnsiString InstructionName, AnsiString * AttrArray, const int AttrArray_Size)/* overload */;
	...
	void __fastcall WriteTag(AnsiString TagName, AnsiString Text, AnsiString * AttrArray, const int AttrArray_Size, bool StartNewLine, bool CloseTagNewLine, bool CheckEntity = true)/* overload */;
	...
	void __fastcall WriteTag(AnsiString TagName, AnsiString Text, AnsiString * AttrArray, const int AttrArray_Size)/* overload */;
	...
	void __fastcall WriteTagNode(AnsiString TagName, AnsiString * AttrArray, const int AttrArray_Size, bool StartNewLine, bool CloseTagNewLine, bool CheckEntity = true)/* overload */;
	...
	void __fastcall WriteTagNode(AnsiString TagName, AnsiString * AttrArray, const int AttrArray_Size)/* overload */;
