...
// (DO NOT EDIT: machine generated header) 'Zsspxml.pas' rev: 10.00
...
private:
	...
	void __fastcall SetAttr(int num, AnsiString const Value);
...
public:
	...
	void __fastcall Add(AnsiString const * Attr, bool TestMatch = true)/* overload */;
	void __fastcall Add(AnsiString * Att, const int Att_Size, bool TestMatch = true)/* overload */;
	...
	void __fastcall Insert(int Index, AnsiString const * Attr, bool TestMatch = true)/* overload */;
...
public:
	...
	void __fastcall WriteEmptyTag(const AnsiString TagName, AnsiString * AttrArray, const int AttrArray_Size, bool StartNewLine, bool CheckEntity = true)/* overload */;
	...
	void __fastcall WriteEmptyTag(const AnsiString TagName, AnsiString * AttrArray, const int AttrArray_Size)/* overload */;
	...
	void __fastcall WriteInstruction(const AnsiString InstructionName, AnsiString * AttrArray, const int AttrArray_Size, bool StartNewLine, bool CheckEntity = true)/* overload */;
	...
	void __fastcall WriteInstruction(const AnsiString InstructionName, AnsiString * AttrArray, const int AttrArray_Size)/* overload */;
	...
	void __fastcall WriteTag(const AnsiString TagName, const AnsiString Text, AnsiString * AttrArray, const int AttrArray_Size, bool StartNewLine, bool CloseTagNewLine, bool CheckEntity = true)/* overload */;
	...
	void __fastcall WriteTag(const AnsiString TagName, const AnsiString Text, AnsiString * AttrArray, const int AttrArray_Size)/* overload */;
	...
	void __fastcall WriteTagNode(const AnsiString TagName, AnsiString * AttrArray, const int AttrArray_Size, bool StartNewLine, bool CloseTagNewLine, bool CheckEntity = true)/* overload */;
	...
	void __fastcall WriteTagNode(const AnsiString TagName, AnsiString * AttrArray, const int AttrArray_Size)/* overload */;
