...
//ѕереводит дату в строку дл€ XML (YYYY-MM-DDTHH:MM:SS)
...
//ѕереводит число в строку минимальной длины NullCount
//TODO: надо гл€нуть что с функци€ми в FlyLogReader-е
//INPUT
//      value: integer     - число
...
//ѕереводит дату в строку дл€ XML (YYYY-MM-DDTHH:MM:SS)
//INPUT
//    ATime: TDateTime - нужна€ дата/врем€
function ZEDateToStr(ATime: TDateTime): string;
var
  HH, MM, SS, MS: word;
