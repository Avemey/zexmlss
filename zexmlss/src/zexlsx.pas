...
///Differential Formatting
  ...
  private
    ...
    FUseFontStyles: boolean;        //�������� �� ����� ������
    FFontColor: TColor;             //���� ������
    FFontStyles: TFontStyles;       //����� ������
    FUseBorder: boolean;            //�������� �� �����
    FBorders: TZXLSXDiffBorder;     //��� ������ � �����
    FUseFill: boolean;              //�������� �� �������
    FUseCellPattern: boolean;       //�������� �� ��� �������
    FCellPattern: TZCellPattern;    //��� �������
    FUseBGColor: boolean;           //�������� �� ���� �������
    FBGColor: TColor;               //���� �������
    FUsePatternColor: boolean;      //�������� �� ���� ������� �������
...
type
  ...
  public
    ...
    property FileArray[num: integer]: TZXLSXFileItem read GetFileItem;  //�����
    property ArchFile[num: integer]: string read GetArchFileItem;
    property ArchFilesCount: integer read FArchFilesCount;              //���-�� ������ � ������
    ...
    property RelationsCounts[num: integer]: integer read GetRelationsCounts; //���-�� � ���������
    property RelationsCount: integer read FRelationsCount;                   //���-�� ���������
    property RelationsArray[num: integer]: TZXLSXRelationsArray read GetRelationsArray; //���������
    property SheetRelationNumber: integer read FSheetRelationNumber;
    property isNeedReadComments: boolean read FNeedReadComments;        //����� �� ������ ����������
  end;
...
//INPUT
//  var Stream: TStream                   - ����� ������
//  var ThemaFillsColors: TIntegerDynArray - ������ � ������� �������
//  var ThemaColorCount: integer          - ���-�� ������ �������
//RETURN
//      boolean - true - �� ����������� �������
function ZEXSLXReadTheme(var Stream: TStream; var ThemaFillsColors: TIntegerDynArray; var ThemaColorCount: integer): boolean;
var
...
//�������� �������� �������������� � �������� �� xlsx
//INPUT
//  const xlsxCfType: string              - xlsx ��� ��������� ��������������
//  const xlsxCFOperator: string          - xlsx ��������
//  out CFCondition: TZCondition          - ������������ �������
//  out CFOperator: TZConditionalOperator - ������������ ��������
//RETURN
//      boolean - true - �������� �������������� � �������� ������� ����������
...
var
  ...
  //��������� ��� ��������� ��������������
  //  out isNeddCheckOperator: boolean - ����������, ����� �� ���������
  //                                     ��������
  //RETURN
  //      boolean - true - �� ��, ����� ��������� �����
...
var
  ...
  begin
    ...
    begin
      ...
      begin
        s := xml.Attributes.ItemsByName['r']; //�����
        if (s <> '') then
        begin
        ...
        _type := xml.Attributes.ItemsByName['t']; //���
        ...
        s := xml.Attributes.ItemsByName['s']; //�����
        if (s > '') then
      ...
      begin
        ...
        s := xml.Attributes.ItemsByName['ht']; //� �������?
        if (s > '') then
        begin
  ...
  try
    ...
    begin
      ...
      begin
        ...
        //s := xml.Attributes.ItemsByName['paperHeight']; //���� ���������� paperHeight � Width, �� paperSize ������������
...
var
  ...
  //�������� �����
  //INPUT
  //  var style: TZXLSXCellStyle - ����� XLSX
  ...
  //INPUT
  //  var retColor: TColor      - ������������ ����
  //  var retColorType: byte    - ��� �����: 0 - rgb, 1 - indexed, 2 - theme
  //  var retLumfactor: double  - �������
  ...
  //  var CSA: TZXLSXCellStylesArray  - ������ �� �������
  //  var StyleCount: integer         - ���-�� ������
  ...
  //      b: byte     -
  //  out h: double   - Hue - ��� �����
  //  out s: double   - Saturation - ������������
  //  out l: double   - Lightness (Intensity) - �������� (�������)
  ...
  //��������� �����
  //INPUT
  //  var XMLSSStyle: TZStyle         - ����� � ���������
  //  var XLSXStyle: TZXLSXCellStyle  - ����� � xlsx
...
begin
  ...
  try
    ...
    begin
      ...
      //TODO: �����������, ��� ���������� cellStyleXfs � cellXfs. ��� �� cellStyles?
      ...
      if ((xml.TagName = 'cellXfs') and (xml.TagType = TAG_TYPE_START)) then  //���� �����?
...
//������ ����� �������/������  (*.rels: workbook.xml.rels � .rels)
//INPUT
//  var Stream: TStream                 - ����� ��� ������
//  var Relations: TZXLSXRelationsArray - ������ � �����������
//  var RelationsCount: integer         - ���-��
//  var isWorkSheet: boolean            - ������� workbook.xml.rels
//      needReplaceDelimiter: boolean   - ������� ������������� �������� �����������
//RETURN
//      boolean - true - ������� ���������
function ZE_XSLXReadRelationships(var Stream: TStream; var Relations: TZXLSXRelationsArray; var RelationsCount: integer; var isWorkSheet: boolean; needReplaceDelimiter: boolean): boolean;
var
...
//  const PagesComments: TIntegerDynArray- ������ ������� � ������������� (��������� � ����)
//    CodePageName: string              - �������� ������� ��������
//    BOM: ansistring                   - BOM
...
//    CodePageName: string              - �������� ������� ��������
//    BOM: ansistring                   - BOM
//  var isHaveComments: boolean         - ���������� true, ���� ���� ����������� (����� ������� comments*.xml)
//  const WriteHelper: TZEXLSXWriteHelper - additional data
//RETURN
//      integer
...
var
  _xml: TZsspXMLWriterH;        //��������
  _FontIndex: TIntegerDynArray;  //������������ �������
  _FillIndex: TIntegerDynArray;  //�������
  _BorderIndex: TIntegerDynArray;//�������
...
//        ZPDiagStripe:         s := 'darkUpDark'; ??
  ...
  begin
    ...
    _xml.Attributes.Add('fillId', IntToStr(_FillIndex[NumStyle + 1] + 2), false); //+2 �.�. ������� ������ ���� 2 ����� ����� �������
