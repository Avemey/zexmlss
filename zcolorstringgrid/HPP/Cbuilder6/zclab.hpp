...
// (DO NOT EDIT: machine generated header) 'zclab.pas' rev: 6.00
...
public:
	...
	void __fastcall DrawTextOn(Graphics::TCanvas* ACanvas, AnsiString AText, Types::TRect &ARect, bool CalcOnly, bool ClipArea = false)/* overload */;
	void __fastcall DrawTextOn(Graphics::TCanvas* ACanvas, AnsiString AText, Types::TRect &ARect, Graphics::TColor AColor, bool CalcOnly, bool ClipArea = false)/* overload */;
	__property Canvas ;
