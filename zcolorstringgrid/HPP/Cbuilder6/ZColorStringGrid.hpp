...
// (DO NOT EDIT: machine generated header) 'ZColorStringGrid.pas' rev: 6.00
...
typedef void __fastcall (__closure *TDrawMergeCellEvent)(System::TObject* Sender, int ACol, int ARow, const Types::TRect &Rect, Grids::TGridDrawState State, Graphics::TCanvas* &CellCanvas);

class DELPHICLASS TSelectColor;
class DELPHICLASS TZColorStringGrid;

class DELPHICLASS TMergeCells;
typedef DynamicArray<Types::TRect >  ZColorStringGrid__5;
...
private:
	...
	Types::TRect __fastcall Get_Item(int Num);
...
public:
	...
	Types::TPoint __fastcall GetMergeYY(int ARow);
	__property int Count = {read=FCount, nodefault};
	__property Types::TRect Items[int Num] = {read=Get_Item};
};
...
__published:
	...
	__property Classes::TAlignment HorizontalAlignment = {read=FHorizontalAlignment, write=SetHAlignment, default=0};
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TZInplaceEditor(HWND ParentWindow) : Stdctrls::TMemo(ParentWindow) { }
	#pragma option pop
...
private:
	...
	bool FUseBitMap;
	#pragma pack(push, 1)
	Types::TRect FRctBitmap;
	#pragma pack(pop)
	
	Graphics::TBitmap* FBmp;
	#pragma pack(push, 1)
	Types::TRect FRctRectangle;
	#pragma pack(pop)
	...
	void __fastcall GetCalcRect(Types::TRect &ARect, int &frmparams, int ACol, int ARow, int &NumMergeArea);
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TZColorStringGrid(HWND ParentWindow) : Grids::TStringGrid(ParentWindow) { }
	#pragma option pop
